...
public class VoirCommande extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(commandes == null) {
			...
			stringBuilder.append("<table class=\"tftable\" border=\"1\"><tr><th>ID Commande</th><th>Date</th><th>Articles</th><th>Quantité</th><th>Etat Commande</th><th>Total TTC</th></tr>");
